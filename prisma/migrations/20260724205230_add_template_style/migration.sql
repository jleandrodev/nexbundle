...
INSERT INTO "new_Relationship" ("createdAt", "direction", "enabled", "id", "layout", "mainProductId", "shop", "updatedAt") SELECT "createdAt", "direction", "enabled", "id", "layout", "mainProductId", "shop", "updatedAt" FROM "Relationship";
